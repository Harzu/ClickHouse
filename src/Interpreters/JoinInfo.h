...
struct JoinInfo
{
    ...
    JoinInfo(JoinKind kind_, JoinStrictness strictness_ = JoinStrictness::All, JoinLocality locality_ = JoinLocality::Local, std::vector<JoinActionRef> expression_ = {})
    ...
    static JoinInfo deserialize(ReadBuffer & in, JoinExpressionActions & expression_actions);
};
